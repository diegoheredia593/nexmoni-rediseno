...
export const pt: Dictionary = {
  ...
  phone: {
    eyebrow: "A aplicação",
    title: "É assim que se envia dinheiro",
    lead:
      "Cinco ecrãs, desde que abre a aplicação até saber que o dinheiro chegou. Continue a descer e o telemóvel avança consigo.",
    disclaimer:
      "Maqueta de produto. Os montantes usam as mesmas taxas indicativas da calculadora.",
    steps: [
      { title: "Escolhe para quem", body: "Os destinatários do costume, logo no topo. Nunca mais escrever um IBAN." },
      { title: "Vê a taxa antes de pagar", body: "A taxa é fixada ao começar. O que este ecrã mostra é o que ela recebe." },
      { title: "A discriminação completa", body: "Comissão e diferencial em separado, em euros. Não aparece nada depois." },
      { title: "Acompanha o envio", body: "Cada passo com a sua hora. Sabe onde está o dinheiro sem telefonar a ninguém." },
      { title: "Chega, e nota-se", body: "Aviso nos dois telemóveis e comprovativo descarregável com a referência." },
    ],
    ui: {
      greeting: "Olá, Diego",
      prompt: "Para quem envia hoje?",
      recent: "Recentes",
      send: "Enviar dinheiro",
      youSend: "Envia",
      theyGet: "Recebe",
      rate: "Taxa de câmbio",
      guaranteed: "Fixada 30 min",
      continue: "Continuar",
      reviewTitle: "Reveja o envio",
      amount: "Montante",
      fee: "Comissão de envio",
      spread: "Diferencial",
      totalPay: "Paga no total",
      arrives: "Chega",
      confirm: "Confirmar e pagar",
      trackTitle: "Em curso",
      received: "Recebido",
      converted: "Convertido em dólares",
      onTheWay: "A caminho do banco",
      delivered: "Entregue",
      estimate: "Estimado hoje",
      doneTitle: "Entregue",
      doneNote: "A Rosa já tem o dinheiro na conta.",
